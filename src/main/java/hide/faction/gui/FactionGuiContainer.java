...
public class FactionGuiContainer extends GuiContainer {
	...
	/*
	 * @Override public void initGui() { super.initGui(); buttonList.add(new
	 * GuiButton(0, 100, 100, "AAAAAAAA")); }
	 *
	 * @Override protected void actionPerformed(GuiButton button) throws IOException
	 * { super.actionPerformed(button); System.out.println("HelloWorld"); }
	 *
	 * private static final ResourceLocation GUITEXTURE = new
	 * ResourceLocation("textures/gui/container/generic_54.png");
	 *
	 * public FactionGuiContainer(Container inventorySlotsIn) {
	 * super(inventorySlotsIn); ySize = 222; }
	 *
	 * private static final ResourceLocation TEXTURE = new
	 * ResourceLocation(HideFaction.MODID, "textures/gui/terminal.png");
	 *
	 * @Override protected void drawGuiContainerBackgroundLayer(float partialTicks,
	 * int mouseX, int mouseY) { GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
	 * mc.getTextureManager().bindTexture(GUITEXTURE); int k = (width - xSize) / 2;
	 * int l = (height - ySize) / 2; this.drawTexturedModalRect(k, l, 0, 0, xSize,
	 * ySize); // this.mc.renderEngine.bindTexture(TEXTURE); //
	...
	public void initGui() {
		if (this.mc.playerController.isInCreativeMode()) {
			...
			this.searchField = new GuiTextField(0, this.fontRenderer, this.guiLeft + 82, this.guiTop + 6, 80,
